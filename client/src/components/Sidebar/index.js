        ...
        <>
            <div className={`sidebar ${context.isOpenFilters === true && 'open'}`}>
                ...
                <div className='card border-0 shadow'>
                    <h3>Completar por precio</h3>
                    <RangeSlider value={value} onInput={changePrice} min={100} max={100000} step={5} />
                  

                    <div className='d-flex pt-2 pb-2 priceRange'>
                        <span>Desde: <strong className='text-success'>Bs: {value[0]}</strong></span>
                        <span className='ml-auto'>Desde: <strong className='text-success'>Bs: {value[1]}</strong></span>
                    </div>
                </div>
