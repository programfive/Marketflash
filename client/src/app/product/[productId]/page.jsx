...
const ProductDetails = ({ params }) => {
  ...
  const submitReview = async (e) => {
    e.preventDefault();
    if (!productReview || !productReviewUserName || !rating) {
      return toast.error('Por favor, complete todos los campos requeridos.');
    }
    if (!isSignedIn) return toast.error('Inicie sesión para continuar.');
            ...
            <div className="col-md-7 productInfo">
              ...
              <div className="d-flex align-items-center mb-4 mt-3">
                ...
                <span className="text-dark ml-2">
                  {reviewsArr?.length > 0 && `(${reviewsArr.length} reseñas)`}
                </span>
              </div>

              <div className="priceSec d-flex align-items-center mb-3">
                <span className="text-g priceLarge">
                  Bs {currentProduct?.attributes?.price}
                </span>
                <div className="ml-3 d-flex flex-column">
                  <span className="text-org">
                    {currentProduct?.attributes?.discount}% Descuento
                  </span>
                  <span className="text-light oldPrice">
                    Bs {currentProduct?.attributes?.oldPrice}
                  </span>
                </div>
              </div>
            ...
            <div className="customTabs">
              <ul className="list list-inline">
                ...
                <li className="list-inline-item">
                  ...
                  >
                    Reseñas {reviewsArr?.length > 0 && `(${reviewsArr.length})`}
                  </Button>
                </li>
              </ul>
